...
class UpdateProductRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'first_image.max' => 'The first_image must not be greater than 2MB',
            'second_image.max' => 'The second_image must not be greater than 2MB',
            'third_image.max' => 'The third_image must not be greater than 2MB',
        ];
    }
}
